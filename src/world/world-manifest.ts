...
export const WORLD: Zone[] = [
  ...
  // ── Batch slice 2: the Necromancer spine + Mage start ──
  {
    ...
    questChain: [
      ...
      { id: 'mur-c3-wolves', archetype: 'clear', title: 'The Harbour Wolves',
        summary: 'Cull the wolves prowling the harbour ice.',
  ...
  },
  {
    ...
    questChain: [
      ...
      { id: 'mos-c3-strays', archetype: 'clear', title: 'The Courtyard Strays',
        summary: 'Cull the strays skulking the academy courtyards.',
        enemyFamily: 'corrupted-wildlife', handAuthored: false },
  ...
  // ── Batch slice 1: the Wizard's Nile road + shared trunk ──
  {
    ...
    questChain: [
      ...
      { id: 'cai-c3-stalls', archetype: 'clear', title: 'Jackals at the Stalls',
        summary: 'Drive off the jackals harrying the market stalls.',
        enemyFamily: 'corrupted-wildlife', handAuthored: false },
  ...
  },
  {
    ...
    questChain: [
      ...
      { id: 'kyo-c3-gates', archetype: 'clear', title: 'Strays Beneath the Gates',
        summary: 'Cull the strays denning beneath the gate walks.',
        enemyFamily: 'corrupted-wildlife', handAuthored: false },
  ...
  },
  {
    ...
    questChain: [
      ...
      { id: 'bal-c3-reef', archetype: 'clear', title: 'The Reef Strays',
        summary: 'Cull the strays prowling the reef roads.',
        enemyFamily: 'corrupted-wildlife', handAuthored: false },
  ...
  // ═══════════ BABEL — THE ASSASSIN'S ROAD (6 zones) ═══════════
  {
    ...
    questChain: [
      ...
      { id: 'dub-c3-alleys', archetype: 'clear', title: 'The Alley Jackals',
        summary: 'Drive the jackals out of the souk alleys.',
        enemyFamily: 'corrupted-wildlife', handAuthored: false },
  ...
  // ═══════════ TEOTIHUACAN — THE SAVAGE'S TOUR (8 zones) ═══════════
  {
    ...
    questChain: [
      ...
      { id: 'mex-c3-causeway', archetype: 'clear', title: 'The Causeway Strays',
        summary: 'Cull the strays stalking the lake causeways.',
        enemyFamily: 'corrupted-wildlife', handAuthored: false },
