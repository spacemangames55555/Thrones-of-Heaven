...
export const WORLD: Zone[] = [
  ...
  // ═══════════ BABEL — THE ASSASSIN'S ROAD (6 zones) ═══════════
  {
    id: 'dubai-glass-souk', displayName: 'Dubai (The Glass Souk)', kind: 'city',
    ...
    onHeavenApproach: false, heavenApproachOrder: null, portalSite: false, handAuthored: true,
    questChain: [
      { id: 'dub-01-mentor', archetype: 'story', title: 'The Master of the Glass Souk',
        summary: 'Meet your mentor; learn class basics.', handAuthored: true },
      { id: 'dub-02-first-blood', archetype: 'clear', title: 'Jackals in the Alleys',
        summary: 'Cull corrupted wildlife in the old quarter.', enemyFamily: 'corrupted-wildlife' },
      { id: 'dub-03-discovery', archetype: 'story', title: 'A Blade in the Dark',
        summary: 'Discover the corruption moving along the coast.', handAuthored: true },
      { id: 'dub-04-first-evil', archetype: 'boss', title: 'Evil at the Souk',
        summary: 'Battle the first true evil enemy at the gates.',
        enemyFamily: 'lesser-evil-scouts' },
    ],
  },
  {
    id: 'pearl-coast', displayName: 'The Pearl Coast', kind: 'corridor',
    anchor: { lat: 26.50, lng: 50.50 }, region: 'Gulf', continent: 'Near East',
    pantheon: 'Arabian', homeClass: null, tier: 2, act: 'ACT_II', levelRange: [12, 24],
    biome: 'desert-coast',
    enemyFamilies: ['lesser-evil-scouts', 'evil-raiders', 'veil-ambushers'],
    connectsTo: ['dubai-glass-souk', 'mesopotamian-marshes'],
    onHeavenApproach: false, heavenApproachOrder: null, portalSite: false, handAuthored: false,
    questChain: [
      { id: 'prl-01-coast-road', archetype: 'clear', title: 'The Coast Road North',
        summary: 'Clear the raiders working the pearl coves.', enemyFamily: 'evil-raiders' },
      { id: 'prl-02-pearls-for-passage', archetype: 'fetch', title: 'Pearls for Passage',
        summary: 'Gather pearls to buy the road north.' },
      { id: 'prl-03-past-the-coves', archetype: 'escort', title: 'Past the Raider Coves',
        summary: 'Escort the caravan past the coves.' },
    ],
  },
  {
    id: 'mesopotamian-marshes', displayName: 'The Reed Sea', kind: 'corridor',
    anchor: { lat: 31.00, lng: 47.00 }, region: 'Mesopotamia', continent: 'Near East',
    pantheon: 'Mesopotamian', homeClass: null, tier: 3, act: 'ACT_III', levelRange: [24, 36],
    biome: 'marsh', enemyFamilies: ['dark-casters', 'veil-ambushers', 'hollowed-brutes'],
    connectsTo: ['pearl-coast', 'shinar-muster'],
    onHeavenApproach: false, heavenApproachOrder: null, portalSite: false, handAuthored: false,
    questChain: [
      { id: 'mar-01-reed-king', archetype: 'boss', title: 'The Reed King',
        summary: 'Defeat the region-champion of the marshes (Mental domain).',
        enemyFamily: 'region-champion' },
      { id: 'mar-02-drowned-reeds', archetype: 'clear', title: 'The Drowned Reeds',
        summary: 'Clear the ambushers hiding in the reed sea.', enemyFamily: 'veil-ambushers' },
      { id: 'mar-03-through-the-channels', archetype: 'escort', title: 'Through the Channels',
        summary: 'Bring the caravan through the marsh channels.' },
    ],
  },
  {
    id: 'shinar-muster', displayName: 'The Shinar Muster', kind: 'outpost',
    anchor: { lat: 32.20, lng: 44.80 }, region: 'Babylon', continent: 'Near East',
    pantheon: 'Angelic (contested)', homeClass: null, tier: 4, act: 'ACT_IV', levelRange: [36, 40],
    biome: 'holy-highland', enemyFamilies: ['herald-angels', 'radiant-guardians'],
    connectsTo: ['mesopotamian-marshes', 'processional-way'],
    onHeavenApproach: true, heavenApproachOrder: 1, portalSite: false, handAuthored: true,
    questChain: [
      { id: 'bb-01-azazel-welcome', archetype: 'story', title: 'A Warm Hand at Shinar',
        summary: 'Azazel arrives as patron; frames the march to the Stair. His Babel gift line lives here (prose TODO).',
        handAuthored: true },
      { id: 'bb-02-first-harvest', archetype: 'clear', title: 'Gathering Light',
        summary: 'Harvest light-energy from radiant guardians for the ritual.',
        enemyFamily: 'radiant-guardians' },
    ],
  },
  {
    id: 'processional-way', displayName: 'The Processional Way', kind: 'corridor',
    anchor: { lat: 32.45, lng: 44.55 }, region: 'Babylon', continent: 'Near East',
    pantheon: 'Angelic (contested)', homeClass: null, tier: 5, act: 'ACT_IV', levelRange: [40, 44],
    biome: 'holy-highland',
    enemyFamilies: ['herald-angels', 'radiant-guardians', 'lesser-angels'],
    connectsTo: ['shinar-muster', 'etemenanki-stair'],
    onHeavenApproach: true, heavenApproachOrder: 2, portalSite: false, handAuthored: false,
    questChain: [
      { id: 'bb-03-herald-truth-1', archetype: 'story', title: 'The Herald on the Way',
        summary: 'A herald angel speaks a TRUTH; Azazel inverts it in real time.',
        handAuthored: true },
      { id: 'bb-04-break-the-procession', archetype: 'clear', title: 'Break the Procession',
        summary: 'Break the angelic line holding the sacred way.' },
      { id: 'bb-05-light-convoy', archetype: 'escort', title: 'The Light Convoy',
        summary: 'Move harvested light along the way under attack.' },
      { id: 'bb-06-regional-callback', archetype: 'story', title: 'What You Left Behind',
        summary: 'NEAR EAST CALLBACK — one class-variant script (Assassin). HAND_AUTHORED_TODO x1.',
        handAuthored: true },
      { id: 'bb-07-herald-truth-2', archetype: 'story', title: 'Second Doubt',
        summary: 'A second herald truth cracks the patron facade further.', handAuthored: true },
      { id: 'bb-08-kneeling-angel', archetype: 'boss', title: 'The Kneeling Angel',
        summary: 'Defeat a lesser angel guarding the final approach.',
        enemyFamily: 'lesser-angels' },
      { id: 'bb-09-player-breaks', archetype: 'story', title: 'The Line You Cross',
        summary: "The player's rare breaking line — Near East instance.", handAuthored: true },
      { id: 'bb-10-final-harvest', archetype: 'portal_approach', title: 'Enough Light',
        summary: 'Complete the ritual harvest needed to force the Stair open.' },
    ],
  },
  {
    id: 'etemenanki-stair', displayName: 'Etemenanki (The Stair of Heaven)', kind: 'portal',
    anchor: { lat: 32.54, lng: 44.42 }, region: 'Babylon', continent: 'Near East',
    pantheon: 'Angelic (contested)', homeClass: null, tier: 5, act: 'ACT_IV', levelRange: [44, 46],
    biome: 'portal-threshold', enemyFamilies: ['radiant-guardians', 'lesser-angels'],
    connectsTo: ['processional-way'],
    onHeavenApproach: true, heavenApproachOrder: 3, portalSite: true, handAuthored: true,
    questChain: [
      { id: 'bb-11-mask-drops', archetype: 'story', title: 'The Stair Opens',
        summary: "Azazel's mask drops where humanity was first scattered.", handAuthored: true },
      { id: 'bb-12-cross-threshold', archetype: 'portal_approach', title: 'Into the Light',
        summary: 'Step through — hands control to the Heaven arc (built later).',
        handAuthored: true },
    ],
  },

  // ═══════════ ULURU — THE HUNTER'S SONGLINE (7 zones) ═══════════
  {
    id: 'sydney-harbour-watch', displayName: 'Sydney (The Harbour Watch)', kind: 'city',
    anchor: { lat: -33.87, lng: 151.21 }, region: 'East Coast', continent: 'Oceania',
    ...
    onHeavenApproach: false, heavenApproachOrder: null, portalSite: false, handAuthored: true,
    questChain: [
      { id: 'syd-01-mentor', archetype: 'story', title: 'The Keeper of the Harbour Watch',
        summary: 'Meet your mentor; learn class basics.', handAuthored: true },
      { id: 'syd-02-first-blood', archetype: 'clear', title: 'Strays on the Headlands',
        summary: 'Cull corrupted wildlife along the harbour.', enemyFamily: 'corrupted-wildlife' },
      { id: 'syd-03-discovery', archetype: 'story', title: 'A Broken Song',
        summary: 'Discover the corruption moving inland.', handAuthored: true },
      { id: 'syd-04-first-evil', archetype: 'boss', title: 'Evil at the Watch',
        summary: 'Battle the first true evil enemy at the harbour gate.',
        enemyFamily: 'lesser-evil-scouts' },
    ],
  },
  {
    id: 'blue-mountains-veil', displayName: 'The Blue Mountains', kind: 'corridor',
    anchor: { lat: -33.70, lng: 150.30 }, region: 'East Coast', continent: 'Oceania',
    pantheon: 'Aboriginal Dreaming', homeClass: null, tier: 2, act: 'ACT_II',
    levelRange: [12, 22], biome: 'eucalypt-highland',
    enemyFamilies: ['corrupted-wildlife', 'veil-ambushers'],
    connectsTo: ['sydney-harbour-watch', 'red-track'],
    onHeavenApproach: false, heavenApproachOrder: null, portalSite: false, handAuthored: false,
    questChain: [
      { id: 'blu-01-misted-passes', archetype: 'clear', title: 'The Misted Passes',
        summary: 'Clear the ambushers in the blue haze.', enemyFamily: 'veil-ambushers' },
      { id: 'blu-02-water-for-the-track', archetype: 'fetch', title: 'Water for the Track',
        summary: 'Gather water for the long road west.' },
    ],
  },
  {
    id: 'red-track', displayName: 'The Red Track', kind: 'corridor',
    anchor: { lat: -32.50, lng: 146.00 }, region: 'Outback', continent: 'Oceania',
    pantheon: 'Aboriginal Dreaming', homeClass: null, tier: 3, act: 'ACT_III',
    levelRange: [22, 30], biome: 'outback', enemyFamilies: ['evil-raiders', 'veil-ambushers'],
    connectsTo: ['blue-mountains-veil', 'dry-heart'],
    onHeavenApproach: false, heavenApproachOrder: null, portalSite: false, handAuthored: false,
    questChain: [
      { id: 'red-01-track-warden', archetype: 'boss', title: 'The Track Warden',
        summary: 'Defeat the region-champion of the red track (Physical domain).',
        enemyFamily: 'region-champion' },
      { id: 'red-02-songline-walkers', archetype: 'escort', title: 'The Songline Walkers',
        summary: 'Escort the walkers along the song west.' },
    ],
  },
  {
    id: 'dry-heart', displayName: 'The Dry Heart', kind: 'corridor',
    anchor: { lat: -28.50, lng: 138.00 }, region: 'Outback', continent: 'Oceania',
    pantheon: 'Aboriginal Dreaming', homeClass: null, tier: 3, act: 'ACT_III',
    levelRange: [30, 36], biome: 'red-desert', enemyFamilies: ['dark-casters', 'hollowed-brutes'],
    connectsTo: ['red-track', 'desert-muster'],
    onHeavenApproach: false, heavenApproachOrder: null, portalSite: false, handAuthored: false,
    questChain: [
      { id: 'dry-01-salt-flats', archetype: 'clear', title: 'The Salt Flats',
        summary: 'Clear the casters working the dry lakes.', enemyFamily: 'dark-casters' },
      { id: 'dry-02-last-water', archetype: 'escort', title: 'The Last Water',
        summary: 'Escort the water wagons to the muster.' },
    ],
  },
  {
    id: 'desert-muster', displayName: 'The Desert Muster', kind: 'outpost',
    anchor: { lat: -25.80, lng: 132.00 }, region: 'Red Centre', continent: 'Oceania',
    pantheon: 'Angelic (contested)', homeClass: null, tier: 4, act: 'ACT_IV', levelRange: [36, 40],
    biome: 'holy-highland', enemyFamilies: ['herald-angels', 'radiant-guardians'],
    connectsTo: ['dry-heart', 'songlines-end'],
    onHeavenApproach: true, heavenApproachOrder: 1, portalSite: false, handAuthored: true,
    questChain: [
      { id: 'ul-01-azazel-welcome', archetype: 'story', title: 'A Warm Hand in the Red Centre',
        summary: 'Azazel arrives as patron; frames the march to the Heart Stone.',
        handAuthored: true },
      { id: 'ul-02-first-harvest', archetype: 'clear', title: 'Gathering Light',
        summary: 'Harvest light-energy from radiant guardians for the ritual.',
        enemyFamily: 'radiant-guardians' },
    ],
  },
  {
    id: 'songlines-end', displayName: "The Songline's End", kind: 'corridor',
    anchor: { lat: -25.55, lng: 131.50 }, region: 'Red Centre', continent: 'Oceania',
    pantheon: 'Angelic (contested)', homeClass: null, tier: 5, act: 'ACT_IV', levelRange: [40, 44],
    biome: 'holy-highland',
    enemyFamilies: ['herald-angels', 'radiant-guardians', 'lesser-angels'],
    connectsTo: ['desert-muster', 'uluru-heart-stone'],
    onHeavenApproach: true, heavenApproachOrder: 2, portalSite: false, handAuthored: false,
    questChain: [
      { id: 'ul-03-herald-truth-1', archetype: 'story', title: 'The Herald at the Stone',
        summary: 'A herald angel speaks a TRUTH; Azazel inverts it in real time.',
        handAuthored: true },
      { id: 'ul-04-break-the-line', archetype: 'clear', title: 'Break the Line',
        summary: 'Break the angelic line across the last song.' },
      { id: 'ul-05-light-convoy', archetype: 'escort', title: 'The Light Convoy',
        summary: 'Move harvested light along the songline under attack.' },
      { id: 'ul-06-regional-callback', archetype: 'story', title: 'What You Left Behind',
        summary: 'OCEANIA CALLBACK — one class-variant script (Hunter). HAND_AUTHORED_TODO x1.',
        handAuthored: true },
      { id: 'ul-07-herald-truth-2', archetype: 'story', title: 'Second Doubt',
        summary: 'A second herald truth cracks the patron facade further.', handAuthored: true },
      { id: 'ul-08-kneeling-angel', archetype: 'boss', title: 'The Kneeling Angel',
        summary: 'Defeat a lesser angel guarding the final approach.',
        enemyFamily: 'lesser-angels' },
      { id: 'ul-09-player-breaks', archetype: 'story', title: 'The Line You Cross',
        summary: "The player's rare breaking line — Oceania instance.", handAuthored: true },
      { id: 'ul-10-final-harvest', archetype: 'portal_approach', title: 'Enough Light',
        summary: 'Complete the ritual harvest needed to force the Heart Stone open.' },
    ],
  },
  {
    id: 'uluru-heart-stone', displayName: 'Uluru (The Heart Stone)', kind: 'portal',
    anchor: { lat: -25.34, lng: 131.03 }, region: 'Red Centre', continent: 'Oceania',
    pantheon: 'Angelic (contested)', homeClass: null, tier: 5, act: 'ACT_IV', levelRange: [44, 46],
    biome: 'portal-threshold', enemyFamilies: ['radiant-guardians', 'lesser-angels'],
    connectsTo: ['songlines-end'],
    onHeavenApproach: true, heavenApproachOrder: 3, portalSite: true, handAuthored: true,
    questChain: [
      { id: 'ul-11-mask-drops', archetype: 'story', title: 'The Heart Stone Opens',
        summary: "Azazel's mask drops at the heart of the oldest songs.", handAuthored: true },
      { id: 'ul-12-cross-threshold', archetype: 'portal_approach', title: 'Into the Light',
        summary: 'Step through — hands control to the Heaven arc (built later).',
        handAuthored: true },
    ],
  },

  // ═══════════ TEOTIHUACAN — THE SAVAGE'S TOUR (8 zones) ═══════════
  {
    id: 'mexico-lake-crown', displayName: 'Mexico City (The Lake Crown)', kind: 'city',
    ...
    onHeavenApproach: false, heavenApproachOrder: null, portalSite: false, handAuthored: true,
    questChain: [
      { id: 'mex-01-mentor', archetype: 'story', title: 'The Keeper of the Lake Crown',
        summary: 'Meet your mentor; learn class basics.', handAuthored: true },
      { id: 'mex-02-first-blood', archetype: 'clear', title: 'Strays on the Causeways',
        summary: 'Cull corrupted wildlife on the lake causeways.', enemyFamily: 'corrupted-wildlife' },
      { id: 'mex-03-discovery', archetype: 'story', title: 'Blood in the Water',
        summary: 'Discover the corruption moving south.', handAuthored: true },
      { id: 'mex-04-first-evil', archetype: 'boss', title: 'Evil at the Crown',
        summary: 'Battle the first true evil enemy at the causeway gate.',
        enemyFamily: 'lesser-evil-scouts' },
    ],
  },
  {
    id: 'oaxaca-cloud-valley', displayName: 'Oaxaca (The Cloud Valley)', kind: 'corridor',
    anchor: { lat: 17.07, lng: -96.72 }, region: 'Oaxaca', continent: 'Mesoamerica',
    pantheon: 'Zapotec', homeClass: null, tier: 2, act: 'ACT_II', levelRange: [12, 20],
    biome: 'cloud-highland',
    enemyFamilies: ['corrupted-wildlife', 'lesser-evil-scouts', 'dark-casters'],
    connectsTo: ['mexico-lake-crown', 'palenque-jungle-court'],
    onHeavenApproach: false, heavenApproachOrder: null, portalSite: false, handAuthored: false,
    questChain: [
      { id: 'oax-01-cloud-terraces', archetype: 'clear', title: 'The Cloud Terraces',
        summary: 'Clear the corrupted terraces of the cloud valley.' },
      { id: 'oax-02-zapotec-seal', archetype: 'fetch', title: 'The Zapotec Seal',
        summary: 'Recover a seal to open the jungle road east.' },
    ],
  },
  {
    id: 'palenque-jungle-court', displayName: 'Palenque (The Jungle Court)', kind: 'corridor',
    anchor: { lat: 17.48, lng: -92.05 }, region: 'Chiapas', continent: 'Mesoamerica',
    pantheon: 'Maya', homeClass: null, tier: 2, act: 'ACT_II', levelRange: [20, 26],
    biome: 'jungle-temple', enemyFamilies: ['veil-ambushers', 'dark-casters'],
    connectsTo: ['oaxaca-cloud-valley', 'yucatan-serpent-steps'],
    onHeavenApproach: false, heavenApproachOrder: null, portalSite: false, handAuthored: false,
    questChain: [
      { id: 'pal-01-overgrown-court', archetype: 'clear', title: 'The Overgrown Court',
        summary: 'Clear the ambushers among the ruins.', enemyFamily: 'veil-ambushers' },
      { id: 'pal-02-jungle-dark', archetype: 'escort', title: 'Through the Jungle Dark',
        summary: 'Escort the travelers through the deep jungle.' },
    ],
  },
  {
    id: 'yucatan-serpent-steps', displayName: 'Yucatán (The Serpent Steps)', kind: 'corridor',
    anchor: { lat: 20.70, lng: -88.60 }, region: 'Yucatán', continent: 'Mesoamerica',
    pantheon: 'Maya', homeClass: null, tier: 3, act: 'ACT_III', levelRange: [26, 32],
    biome: 'limestone-scrub', enemyFamilies: ['veil-ambushers', 'hollowed-brutes'],
    connectsTo: ['palenque-jungle-court', 'veracruz-olmec-shore'],
    onHeavenApproach: false, heavenApproachOrder: null, portalSite: false, handAuthored: false,
    questChain: [
      { id: 'yuc-01-serpent-of-the-steps', archetype: 'boss', title: 'The Serpent of the Steps',
        summary: 'Defeat the region-champion of the serpent pyramid (Spiritual domain).',
        enemyFamily: 'region-champion' },
      { id: 'yuc-02-cenote-offering', archetype: 'fetch', title: 'An Offering from the Cenotes',
        summary: 'Gather the offering the road home demands.' },
    ],
  },
  {
    id: 'veracruz-olmec-shore', displayName: 'Veracruz (The Olmec Shore)', kind: 'corridor',
    anchor: { lat: 19.20, lng: -96.10 }, region: 'Gulf Coast', continent: 'Mesoamerica',
    pantheon: 'Olmec', homeClass: null, tier: 3, act: 'ACT_III', levelRange: [32, 36],
    biome: 'gulf-coast', enemyFamilies: ['evil-raiders', 'hollowed-brutes'],
    connectsTo: ['yucatan-serpent-steps', 'valley-muster'],
    onHeavenApproach: false, heavenApproachOrder: null, portalSite: false, handAuthored: false,
    questChain: [
      { id: 'ver-01-stone-heads', archetype: 'clear', title: 'The Stone Heads Watch',
        summary: 'Clear the raiders beneath the colossal heads.', enemyFamily: 'evil-raiders' },
      { id: 'ver-02-caravan-home', archetype: 'escort', title: 'The Caravan Home',
        summary: 'Escort the caravan west along the gulf, back toward the valley.' },
    ],
  },
  {
    id: 'valley-muster', displayName: 'The Valley Muster', kind: 'outpost',
    anchor: { lat: 19.60, lng: -98.90 }, region: 'Valley of Mexico', continent: 'Mesoamerica',
    pantheon: 'Angelic (contested)', homeClass: null, tier: 4, act: 'ACT_IV', levelRange: [36, 40],
    biome: 'holy-highland', enemyFamilies: ['herald-angels', 'radiant-guardians'],
    connectsTo: ['veracruz-olmec-shore', 'avenue-of-the-dead'],
    onHeavenApproach: true, heavenApproachOrder: 1, portalSite: false, handAuthored: true,
    questChain: [
      { id: 'te-01-azazel-welcome', archetype: 'story', title: 'A Warm Hand in the Valley',
        summary: 'Azazel arrives as patron; frames the march up the Avenue.', handAuthored: true },
      { id: 'te-02-first-harvest', archetype: 'clear', title: 'Gathering Light',
        summary: 'Harvest light-energy from radiant guardians for the ritual.',
        enemyFamily: 'radiant-guardians' },
    ],
  },
  {
    id: 'avenue-of-the-dead', displayName: 'The Avenue of the Dead', kind: 'corridor',
    anchor: { lat: 19.68, lng: -98.87 }, region: 'Valley of Mexico', continent: 'Mesoamerica',
    pantheon: 'Angelic (contested)', homeClass: null, tier: 5, act: 'ACT_IV', levelRange: [40, 44],
    biome: 'holy-highland',
    enemyFamilies: ['herald-angels', 'radiant-guardians', 'lesser-angels'],
    connectsTo: ['valley-muster', 'teotihuacan-birthplace'],
    onHeavenApproach: true, heavenApproachOrder: 2, portalSite: false, handAuthored: false,
    questChain: [
      { id: 'te-03-herald-truth-1', archetype: 'story', title: 'The Herald on the Avenue',
        summary: 'A herald angel speaks a TRUTH; Azazel inverts it in real time.',
        handAuthored: true },
      { id: 'te-04-break-the-avenue', archetype: 'clear', title: 'Break the Avenue',
        summary: 'Break the angelic line holding the Avenue of the Dead.' },
      { id: 'te-05-light-convoy', archetype: 'escort', title: 'The Light Convoy',
        summary: 'Move harvested light up the avenue under attack.' },
      { id: 'te-06-regional-callback', archetype: 'story', title: 'What You Left Behind',
        summary: 'MESOAMERICA CALLBACK — one class-variant script (Savage). HAND_AUTHORED_TODO x1.',
        handAuthored: true },
      { id: 'te-07-herald-truth-2', archetype: 'story', title: 'Second Doubt',
        summary: 'A second herald truth cracks the patron facade further.', handAuthored: true },
      { id: 'te-08-kneeling-angel', archetype: 'boss', title: 'The Kneeling Angel',
        summary: 'Defeat a lesser angel guarding the final approach.',
        enemyFamily: 'lesser-angels' },
      { id: 'te-09-player-breaks', archetype: 'story', title: 'The Line You Cross',
        summary: "The player's rare breaking line — Mesoamerica instance.", handAuthored: true },
      { id: 'te-10-final-harvest', archetype: 'portal_approach', title: 'Enough Light',
        summary: 'Complete the ritual harvest needed to force the Birthplace open.' },
    ],
  },
  {
    id: 'teotihuacan-birthplace', displayName: 'Teotihuacan (Birthplace of the Gods)',
    kind: 'portal', anchor: { lat: 19.69, lng: -98.84 }, region: 'Valley of Mexico',
    continent: 'Mesoamerica', pantheon: 'Angelic (contested)', homeClass: null, tier: 5,
    act: 'ACT_IV', levelRange: [44, 46], biome: 'portal-threshold',
    enemyFamilies: ['radiant-guardians', 'lesser-angels'],
    connectsTo: ['avenue-of-the-dead'],
    onHeavenApproach: true, heavenApproachOrder: 3, portalSite: true, handAuthored: true,
    questChain: [
      { id: 'te-11-mask-drops', archetype: 'story', title: 'The Birthplace Opens',
        summary: "Azazel's mask drops where the gods were manufactured.", handAuthored: true },
      { id: 'te-12-cross-threshold', archetype: 'portal_approach', title: 'Into the Light',
        summary: 'Step through — hands control to the Heaven arc (built later).',
        handAuthored: true },
    ],
  },
