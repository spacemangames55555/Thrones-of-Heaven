...
export const WORLD: Zone[] = [
  ...
  // ── Batch slice 1: the Rome spine + Act IV core ──
  {
    ...
    questChain: [
      ...
      { id: 'rom-c1-errand', archetype: 'deliver', title: 'Candles for the Altar',
        summary: 'Carry altar candles from the Keeper to Lucia by the basilica steps.', handAuthored: false },
      { id: 'rom-02-catacomb-vermin', archetype: 'clear', title: 'Below the Streets',
        summary: 'Cull the corrupted ruin cats in the catacombs.', enemyFamily: 'corrupted-wildlife' },
      { id: 'rom-c2-hands', archetype: 'fetch', title: 'Bread on the Stoops',
        summary: 'Leave three bread parcels on the stoops of the old quarter.', handAuthored: false },
      { id: 'rom-c3-dawn', archetype: 'escort', title: 'The Dawn Delivery',
        summary: 'Walk Lucia\'s dawn bread delivery through the quarter.', handAuthored: false },
  ...
  // ── Batch slice 2: the Necromancer spine + Mage start ──
  {
    ...
    questChain: [
      ...
      { id: 'mur-c1-errand', archetype: 'deliver', title: 'Oil for the Dock Hut',
        summary: 'Carry lamp-oil from the Keeper down to Old Varya\'s dock hut.', handAuthored: false },
      { id: 'mur-02-ice-roads', archetype: 'clear', title: 'The Ice Roads',
        summary: 'Cull the corrupted reindeer on the harbor roads.', enemyFamily: 'corrupted-wildlife' },
      { id: 'mur-c2-hands', archetype: 'fetch', title: 'The Lost Floats',
        summary: 'Recover three lost net-floats along the frozen shore.', handAuthored: false },
      { id: 'mur-c3-wolves', archetype: 'clear', title: 'The Harbour Reindeer',
        summary: 'Cull the reindeer prowling the harbour ice.',
        enemyFamily: 'corrupted-wildlife', handAuthored: false },
  ...
  },
  {
    ...
    questChain: [
      { id: 'mos-01-mentor', archetype: 'story', title: 'The Elder of the Academies',
        summary: 'Meet your mentor; learn class basics.', handAuthored: true },
      { id: 'mos-c1-errand', archetype: 'deliver', title: 'A Lens for the Glazier',
        summary: 'Carry a crystal lens from the Elder to Fyodor\'s workshop.', handAuthored: false },
      { id: 'mos-02-outer-ring', archetype: 'clear', title: 'The Outer Ring',
        summary: 'Cull the corrupted ravens beyond the walls.', enemyFamily: 'corrupted-wildlife' },
      { id: 'mos-c2-hands', archetype: 'fetch', title: 'Shards at the Fountain',
        summary: 'Collect three crystal shards at the frozen fountain.', handAuthored: false },
      { id: 'mos-c3-strays', archetype: 'clear', title: 'The Courtyard Ravens',
        summary: 'Cull the ravens skulking the academy courtyards.',
        enemyFamily: 'corrupted-wildlife', handAuthored: false },
  ...
  },
  {
    ...
    questChain: [
      ...
      { id: 'mun-c1-errand', archetype: 'deliver', title: 'Hinges for the Anvil\'s Rest',
        summary: 'Carry fresh-forged hinges from the Forge-Master to Greta at the inn.', handAuthored: false },
      { id: 'mun-02-foothill-wolves', archetype: 'clear', title: 'Roe Deer off the Roads',
        summary: 'Cull the corrupted roe deer on the foothill roads.', enemyFamily: 'corrupted-wildlife' },
      { id: 'mun-c2-hands', archetype: 'fetch', title: 'Firewood for the Hearth',
        summary: 'Gather three firewood bundles from the wood-lots around the hold.', handAuthored: false },
      { id: 'mun-c3-cart', archetype: 'escort', title: 'Greta\'s Cart',
        summary: 'Walk Greta\'s laden cart safely to the market square.', handAuthored: false },
  ...
  },
  {
    ...
    questChain: [
      ...
      { id: 'lon-c1-errand', archetype: 'deliver', title: 'Wicks for the Lamps',
        summary: 'Carry new wicks from the Loremaster to Wren the lamplighter.', handAuthored: false },
      { id: 'lon-02-first-blood', archetype: 'clear', title: 'Foxes in the Boroughs',
        summary: 'Cull the corrupted foxes in the outer boroughs.', enemyFamily: 'corrupted-wildlife' },
      { id: 'lon-c2-hands', archetype: 'fetch', title: 'Dark Lamps',
        summary: 'Relight three dark lamps along the borough streets.', handAuthored: false },
      { id: 'lon-c3-round', archetype: 'escort', title: 'The Evening Round',
        summary: 'Walk Wren\'s evening lamplighting round through the boroughs.', handAuthored: false },
  ...
  // ── Batch slice 1: the Wizard's Nile road + shared trunk ──
  {
    ...
    questChain: [
      { id: 'cai-01-mentor', archetype: 'story', title: 'The Keeper of the Old Kingdom',
        summary: 'Meet your mentor; learn class basics.', handAuthored: true },
      { id: 'cai-c1-errand', archetype: 'deliver', title: 'Water for the Stalls',
        summary: 'Carry blessed river-water jars from the Keeper to Amara\'s date stall.', handAuthored: false },
      { id: 'cai-02-first-blood', archetype: 'clear', title: 'Ibis at the Delta',
        summary: 'Cull the corrupted sacred ibis on the delta roads.', enemyFamily: 'corrupted-wildlife' },
      { id: 'cai-c2-hands', archetype: 'fetch', title: 'After the Storm',
        summary: 'Gather three storm-fallen palm fronds along the gate road.', handAuthored: false },
      { id: 'cai-c3-stalls', archetype: 'clear', title: 'Ibis at the Stalls',
        summary: 'Drive off the sacred ibis harrying the market stalls.',
        enemyFamily: 'corrupted-wildlife', handAuthored: false },
  ...
  },
  {
    ...
    questChain: [
      { id: 'kin-01-mentor', archetype: 'story', title: 'The Keeper of the Drum',
        summary: 'Meet your mentor; learn class basics.', handAuthored: true },
      { id: 'kin-c1-errand', archetype: 'deliver', title: 'Herbs for the Pot',
        summary: 'Carry river herbs from the Keeper to Mama Nsimba\'s market kitchen.', handAuthored: false },
      { id: 'kin-02-first-blood', archetype: 'clear', title: 'The River Roads',
        summary: 'Cull the corrupted bonobos along the great river.', enemyFamily: 'corrupted-wildlife' },
      { id: 'kin-c2-hands', archetype: 'fetch', title: 'Drum-Wood',
        summary: 'Gather three drum-wood branches from the river groves.', handAuthored: false },
      { id: 'kin-c3-landing', archetype: 'escort', title: 'To the River Landing',
        summary: 'See Mama Nsimba\'s stores safely down to the river landing.', handAuthored: false },
  ...
  // ── Batch slice 1: the Monk's road + Act IV core + Samurai start ──
  {
    ...
    questChain: [
      { id: 'lha-01-mentor', archetype: 'story', title: 'The Abbot of the High Citadel',
        summary: 'Meet your mentor; learn class basics.', handAuthored: true },
      { id: 'lha-c1-errand', archetype: 'deliver', title: 'Butter-Tea for the House',
        summary: 'Carry butter-tea bricks from the Abbot to Pemba\'s tea house.', handAuthored: false },
      { id: 'lha-02-first-blood', archetype: 'clear', title: 'Pikas on the Kora',
        summary: 'Cull the corrupted pikas on the pilgrim paths.', enemyFamily: 'corrupted-wildlife' },
      { id: 'lha-c2-hands', archetype: 'fetch', title: 'The Prayer Wheels',
        summary: 'Turn three prayer wheels along the pilgrim path.', handAuthored: false },
      { id: 'lha-c3-pilgrim', archetype: 'escort', title: 'The Pilgrim\'s Steps',
        summary: 'Walk a pilgrim elder safely up the citadel steps.', handAuthored: false },
  ...
  },
  {
    ...
    questChain: [
      { id: 'kyo-01-mentor', archetype: 'story', title: 'The Master of the Thousand Gates',
        summary: 'Meet your mentor; learn class basics.', handAuthored: true },
      { id: 'kyo-c1-errand', archetype: 'deliver', title: 'The Blessing Tablet',
        summary: 'Carry a blessing tablet from the Master to Hana at the shrine.', handAuthored: false },
      { id: 'kyo-02-first-blood', archetype: 'clear', title: 'Tanuki Below the Shrines',
        summary: 'Cull the corrupted tanuki on the shrine paths.', enemyFamily: 'corrupted-wildlife' },
      { id: 'kyo-c2-hands', archetype: 'fetch', title: 'The Gate Shrines',
        summary: 'Tend the three small shrines beneath the thousand gates.', handAuthored: false },
      { id: 'kyo-c3-gates', archetype: 'clear', title: 'Tanuki Beneath the Gates',
        summary: 'Cull the tanuki denning beneath the gate walks.',
        enemyFamily: 'corrupted-wildlife', handAuthored: false },
  ...
  },
  {
    ...
    questChain: [
      { id: 'bal-01-mentor', archetype: 'story', title: 'The Keeper of the Drowned Crown',
        summary: 'Meet your mentor; learn class basics.', handAuthored: true },
      { id: 'bal-c1-errand', archetype: 'deliver', title: 'Baskets for the Offerings',
        summary: 'Carry woven baskets from the Keeper to Ketut the offering-maker.', handAuthored: false },
      { id: 'bal-02-first-blood', archetype: 'clear', title: 'The Reef Roads',
        summary: 'Cull the corrupted macaques along the shore.', enemyFamily: 'corrupted-wildlife' },
      { id: 'bal-c2-hands', archetype: 'fetch', title: 'The Shore Offerings',
        summary: 'Place three offerings where the tide can take them.', handAuthored: false },
      { id: 'bal-c3-reef', archetype: 'clear', title: 'The Reef Macaques',
        summary: 'Cull the macaques prowling the reef roads.',
        enemyFamily: 'corrupted-wildlife', handAuthored: false },
  ...
  // ═══════════ BABEL — THE ASSASSIN'S ROAD (6 zones) ═══════════
  {
    ...
    questChain: [
      { id: 'dub-01-mentor', archetype: 'story', title: 'The Master of the Glass Souk',
        summary: 'Meet your mentor; learn class basics.', handAuthored: true },
      { id: 'dub-c1-errand', archetype: 'deliver', title: 'Sand for the Furnace',
        summary: 'Carry furnace sand from the Master to Rashid\'s glassworks.', handAuthored: false },
      { id: 'dub-02-first-blood', archetype: 'clear', title: 'Gazelles in the Alleys',
        summary: 'Cull the corrupted sand gazelles in the old quarter.', enemyFamily: 'corrupted-wildlife' },
      { id: 'dub-c2-hands', archetype: 'fetch', title: 'The Toppled Stall',
        summary: 'Recover three scattered wares from a toppled souk stall.', handAuthored: false },
      { id: 'dub-c3-alleys', archetype: 'clear', title: 'The Alley Gazelles',
        summary: 'Drive the sand gazelles out of the souk alleys.',
        enemyFamily: 'corrupted-wildlife', handAuthored: false },
  ...
  // ═══════════ ULURU — THE HUNTER'S SONGLINE (7 zones) ═══════════
  {
    ...
    questChain: [
      { id: 'syd-01-mentor', archetype: 'story', title: 'The Keeper of the Harbour Watch',
        summary: 'Meet your mentor; learn class basics.', handAuthored: true },
      { id: 'syd-c1-errand', archetype: 'deliver', title: 'Rope for the Ferry',
        summary: 'Carry rope coils from the Keeper to Banjo at the ferry berth.', handAuthored: false },
      { id: 'syd-02-first-blood', archetype: 'clear', title: 'Kookaburras on the Headlands',
        summary: 'Cull the corrupted kookaburras along the harbour.', enemyFamily: 'corrupted-wildlife' },
      { id: 'syd-c2-hands', archetype: 'fetch', title: 'The Crab Pots',
        summary: 'Recover three crab pots along the harbour shore.', handAuthored: false },
      { id: 'syd-c3-jetty', archetype: 'escort', title: 'To the Far Jetty',
        summary: 'See Banjo safely across to the far jetty.', handAuthored: false },
  ...
  // ═══════════ TEOTIHUACAN — THE SAVAGE'S TOUR (8 zones) ═══════════
  {
    ...
    questChain: [
      { id: 'mex-01-mentor', archetype: 'story', title: 'The Keeper of the Lake Crown',
        summary: 'Meet your mentor; learn class basics.', handAuthored: true },
      { id: 'mex-c1-errand', archetype: 'deliver', title: 'Sickles for the Chinampas',
        summary: 'Carry obsidian sickles from the Keeper to Itzel on the canals.', handAuthored: false },
      { id: 'mex-02-first-blood', archetype: 'clear', title: 'Axolotls on the Causeways',
        summary: 'Cull the corrupted axolotls on the lake causeways.', enemyFamily: 'corrupted-wildlife' },
      { id: 'mex-c2-hands', archetype: 'fetch', title: 'The Maize Bundles',
        summary: 'Gather three maize bundles from the chinampa rows.', handAuthored: false },
      { id: 'mex-c3-causeway', archetype: 'clear', title: 'The Causeway Axolotls',
        summary: 'Cull the axolotls stalking the lake causeways.',
        enemyFamily: 'corrupted-wildlife', handAuthored: false },
