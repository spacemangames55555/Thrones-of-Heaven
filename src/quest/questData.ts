...
import { WORLD_GLOBE, WORLD_HEAVEN, WORLD_HELL, type WorldId } from '../world/worlds';
...
export const TARGET_WORLD: Record<TargetKind, WorldId> = {
  olympia: WORLD_GLOBE,
  'tree-line': WORLD_GLOBE,
  'tacoma-beach': WORLD_GLOBE,
  'snoqualmie-pass': WORLD_GLOBE,
  'pells-farm': WORLD_GLOBE,
  'corrupted-grove': WORLD_GLOBE,
  'whitepass-farm': WORLD_GLOBE,
  yakima: WORLD_GLOBE,
  'lake-chelan': WORLD_GLOBE,
  bellingham: WORLD_GLOBE,
  cascades: WORLD_GLOBE,
  seattle: WORLD_GLOBE,
  longview: WORLD_GLOBE,
  'oregon-rift': WORLD_GLOBE,
  sasquatch: WORLD_GLOBE,
  rift: WORLD_GLOBE,
  npc: WORLD_GLOBE,
  bend: WORLD_GLOBE,
  'la-grande': WORLD_GLOBE,
  'caravan-route': WORLD_GLOBE,
  florence: WORLD_GLOBE,
  roseburg: WORLD_GLOBE,
  kamiah: WORLD_GLOBE,
  'river-1': WORLD_GLOBE,
  'river-2': WORLD_GLOBE,
  'river-3': WORLD_GLOBE,
  ...
  'city-3': WORLD_GLOBE,
  boise: WORLD_GLOBE,
  'catapult-1': WORLD_GLOBE,
  'catapult-2': WORLD_GLOBE,
  'catapult-3': WORLD_GLOBE,
  'azazel-heaven': WORLD_HEAVEN,
  outpost: WORLD_GLOBE,
  'oregon-city': WORLD_GLOBE,
  'farm-field': WORLD_GLOBE,
  shipment: WORLD_GLOBE,
  'loc-a': WORLD_GLOBE,
  'loc-b': WORLD_GLOBE,
  'holy-outpost': WORLD_GLOBE,
